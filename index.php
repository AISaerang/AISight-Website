...
<head>
    ...
    <meta name="description" content="Selamat datang di AISight - Platform pembelajaran dan portofolio AI."/>
    <meta property="og:title" content="AISight — Beranda"/>
    <meta property="og:description" content="Selamat datang di AISight - Platform pembelajaran dan portofolio AI."/>
    <meta property="og:type" content="website"/>
    <title>AISight — Beranda</title>
    <style>
        :root {
            --bg: #0B1220;
            --surface: #0F172A;
...
<body>
            ...
            <div class="auth-buttons">
                <?php if (isset($_SESSION['user'])): ?>
                    <div class="user-profile">
                        <img src="<?php echo htmlspecialchars($_SESSION['user']['profile_image'] ?: 'assets/img/default-avatar.jpg'); ?>" alt="Profile" class="profile-img">
                        <span class="profile-name"><?php echo htmlspecialchars($_SESSION['user']['name'] ?: $_SESSION['user']['username']); ?></span>
                    </div>
    ...
    <section class="hero">
        <h1>Selamat Datang di AISight</h1>
        <p>Temukan pembelajaran AI yang inovatif dan bangun portofolio Anda dengan proyek-proyek menarik.</p>
        <a href="overview.php" class="btn">Mulai Belajar</a>
    </section>
