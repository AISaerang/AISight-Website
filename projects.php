...
<head>
  ...
  <meta name="description" content="Detail project dari tutor dan murid AISight termasuk insight dan laporan interaktif."/>
  <meta property="og:title" content="AISight — Detail Project"/>
  <meta property="og:description" content="Detail project dari tutor dan murid AISight termasuk insight dan laporan interaktif."/>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .insight-dropdown { margin: 16px 0; }
    .insight-header { background: var(--card); border: 1px solid var(--border); padding: 12px; cursor: pointer; display: flex; justify-content: space-between; align-items: center; border-radius: var(--radius); font-weight: 600; }
    .insight-content { display: none; padding: 12px; background: var(--surface); border: 1px solid var(--border); border-top: none; border-radius: 0 0 var(--radius) var(--radius); }
    ...
    @media (max-width: 720px) {
      ...
      .report-container { height: calc(100vh - 160px); }
      .nav-menu {
        display: none;
        position: absolute;
        top: 60px;
    ...
    <div class="inner">
      <div class="title-container">
        <div class="back-btn-container">
          <a href="overview.html" class="back-btn">Kembali ke Overview</a>
        </div>
        <h1 class="title"><?php echo htmlspecialchars($project ? $project['name'] . ' - ' . $project['tutor'] : 'Project Detail: Tidak Ditemukan'); ?></h1>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      <div class="insight-dropdown">
        ...
        <div class="insight-content">
          ...
          <?php else: ?>
            <p>Project tidak ditemukan atau parameter tidak valid.</p>
          <?php endif; ?>
        </div>
      </div>
      <div class="report-container">
        <iframe src="<?php echo htmlspecialchars($project ? $project['url'] : ''); ?>" frameborder="0"></iframe>
      </div>
    </div>
  </main>
